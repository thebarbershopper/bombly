...
class WireSequenceRule(CompoundRule):
    ...
    def _process_recognition(self, node, extras):   # Callback when command is spoken.
        ...
        words = words.replace('read', 'red').replace('blew', 'blue')
        print words
        words = [word for word in words.split() if word in ('red', 'blue', 'black', 'alpha', 'bravo', 'charlie')]
        print words
...
class WordsRule(CompoundRule):
    ...
    def _process_recognition(self, node, extras):   # Callback when command is spoken.
        ...
        combos = {
            ...
            ('they', 'mark'): "they're",
            ('they', 'contraction'): "they're",
            ('they', 'apostrophe'): "they're",
            ('CS'): "see",
            ('charlie',): "c",
            ('C.', 'C.'): "cee",
            ('CC',): "cee",
            ...
            ('affirmative',): 'uh huh',
            ('negative',): 'uh uh',
            ('affirmative', 'grunt',): 'uh huh',
            ('negative', 'grunt',): 'uh uh',
            ('five', 'letters'): 'uh huh',
            ('four', 'letters'): 'uh uh',
            ('what', 'mark'): 'what?',
            ('what', 'question'): 'what?',
        ...
        responses = {
            ...
            "yes": ("yes",),
            "what": ("what", "no", "mark"),
            "uhhh": ("uniform" "hotel" "hotel" "hotel"),
            "left": ("left",),
            "right": ("right",),
            "right": ("write",),
            "middle": ("middle",),
            "wait": ("wait",),
            "press": ("press",),
            "uh huh": ("uniform" "hotel", "hotel" "uniform" "hotel"),
            "uh uh": ("uniform" "hotel", "uniform" "hotel"),
            "what?": ("what", "question"),
            "done": ("done",),
            "next": ("next",),
            "hold": ("hold",),
